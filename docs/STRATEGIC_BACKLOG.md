...
| **L** | [System Overhaul] | [1-liner value] | [Specific Trigger] |

---

## Later

- [ ] **[Item]**: proof-run dummy for chrome-extension. Blocked by [resource/trigger].
- [ ] **[Item]**: proof-run dummy for chrome-extension. Blocked by [resource/trigger].
...
3. **Measurable failure**: A "functional but fragile" component begins
