# Project File Index — fabrik-test-chrome-extension
...
| **docs/development/plans/** | Plan documents | `2026-05-06-plan-<n>.md` files |
...
| Document | Purpose |
|----------|--------|
| [QUICKSTART.md](docs/QUICKSTART.md) | Get fabrik-test-chrome-extension running in 5 minutes |
